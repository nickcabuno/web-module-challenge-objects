...
function createMenuItem(item, x, period){
  return {name: item, price: x, category: period};
}
...
createMenuItem("hot dog", 50, "dinner");
createMenuItem("filet minon", 5, "dinner")
...
reviews.push({name: "Nick", rating: 1, feedback: "i hated it"});
  console.log(reviews);
